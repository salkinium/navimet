...
/// STM32L4 running at 52MHz generated with the PLL from 4MHz MSI clock

struct SystemClock {
	static constexpr uint32_t Frequency = 4_MHz * 26 / 2;
...
using LoggerDevice = modm::IODeviceWrapper< stlink::Uart, modm::IOBuffer::DiscardIfFull >;
