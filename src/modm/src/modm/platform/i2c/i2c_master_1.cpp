...
#	define DEBUG_STREAM(x) MODM_LOG_ERROR << x << "\n"
#	define DEBUG_STREAM_N(x) MODM_LOG_ERROR << x
#else
...
namespace
{
	...
	callWriteOperation(const bool startCondition)
	{
		...
		I2C1->CR2 = (autoend ? I2C_CR2_AUTOEND : 0 ) |
		...
		I2C1->CR1 &= ~(I2C_CR1_STOPIE | I2C_CR1_TCIE | I2C_CR1_RXIE | I2C_CR1_TXIE);
	...
	callReadOperation(const bool startCondition)
	{
		...
		else
		{
			...
			I2C1->CR1 |= I2C_CR1_RXIE | I2C_CR1_STOPIE | (reload ? I2C_CR1_TCIE : 0);
		}
	}
	...
	callStarting()
	{
		...
		switch (starting.next)
		{
			...
			case modm::I2c::OperationAfterStart::Stop:
				...
				// Reload = 0
				I2C1->CR2 = I2C_CR2_AUTOEND | (0 << I2C_CR2_NBYTES_Pos) | \
	...
	callNextTransaction()
	{
		if (queue.isNotEmpty())
		{
			...
			while ((I2C1->ISR & I2C_ISR_STOPF) and (deadlockPreventer-- > 0))
				{};
...
void
modm::platform::I2cMaster1::initializeWithPrescaler(uint32_t timingRegisterValue)
{
	...
	I2C1->TIMINGR = timingRegisterValue & TIMING_CLEAR_MASK;
	...
	switch (addressingMode)
	{
		case AddressingMode::Bit7:
			I2C1->OAR1 = (I2C_OAR1_OA1EN | own_address);
			break;
		case AddressingMode::Bit10:
			I2C1->OAR1 = (I2C_OAR1_OA1EN | I2C_OAR1_OA1MODE | own_address);
