...
public:
	...
	struct In6 { static void connect();
		static_assert(
			...
			"GpioA1::In6 only connects to Adc1!");
	};
	template< Peripheral peripheral >
	...
	struct Sck { static void connect();
		static_assert(
			...
			"GpioA1::Sck only connects to Spi1!");
	};
	template< Peripheral peripheral >
	struct Smba { static void connect();
		static_assert(
			(peripheral == Peripheral::I2c1),
			"GpioA1::Smba only connects to I2c1!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioA1::Sck<Peripheral::Spi1>
{
	using Gpio = GpioA1;
...
template<>
struct GpioA1::Smba<Peripheral::I2c1>
{
	using Gpio = GpioA1;
