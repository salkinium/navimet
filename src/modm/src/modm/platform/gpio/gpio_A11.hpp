...
template<>
struct GpioA11::Dm<Peripheral::Usb>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Miso<Peripheral::Spi1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Out<Peripheral::Comp1>
{
	using Gpio = GpioA11;
