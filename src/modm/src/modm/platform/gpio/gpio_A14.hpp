...
public:
	...
	struct FsB { static void connect();
		static_assert(
			...
			"GpioA14::FsB only connects to Sai1!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioA14::FsB<Peripheral::Sai1>
{
	using Gpio = GpioA14;
...
template<>
struct GpioA14::Out<Peripheral::Lptim1>
{
	using Gpio = GpioA14;
...
template<>
struct GpioA14::Rx<Peripheral::Swpmi1>
{
	using Gpio = GpioA14;
...
template<>
struct GpioA14::Smba<Peripheral::I2c1>
{
	using Gpio = GpioA14;
