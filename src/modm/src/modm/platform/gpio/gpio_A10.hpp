...
public:
	...
	template< Peripheral peripheral >
	struct CrsSync { static void connect();
		static_assert(
			(peripheral == Peripheral::None),
			"GpioA10::CrsSync only connects to None!");
	};
	template< Peripheral peripheral >
	...
	struct SdA { static void connect();
		static_assert(
			...
			"GpioA10::SdA only connects to Sai1!");
	};
	template< Peripheral peripheral >
	struct Sda { static void connect();
		static_assert(
			(peripheral == Peripheral::I2c1),
			"GpioA10::Sda only connects to I2c1!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioA10::CrsSync<Peripheral::None>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::SdA<Peripheral::Sai1>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::Sda<Peripheral::I2c1>
{
	using Gpio = GpioA10;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Sda;
